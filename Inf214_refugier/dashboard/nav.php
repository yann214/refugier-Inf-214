<div id="mySidenav" class="sidenav">
	<p class="logo"><span>M</span>-Refugier</p>
  <a href="index.php" class="icon-a"><i class="fa fa-dashboard icons"></i> &nbsp;&nbsp;Tableau de bord</a>
  <a href="enregistrement.php"class="icon-a"><i class="fa fa-users icons"></i> &nbsp;&nbsp;Enregistrement</a>
  <a href="logement.php"class="icon-a"><i class="fa fa-list icons"></i> &nbsp;&nbsp;Logement</a>
